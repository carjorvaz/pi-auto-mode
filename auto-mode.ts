...
const NEVER_AUTO_APPROVE = new Set(["bash", "write", "edit"]);
...
const DANGEROUS_PATTERNS = [
	/\brm\s+(-[rf]|[a-z]*[rf]|--recursive|--force)\b/i,
	/\bsudo\b/i,
...
function parseClassifierResponse(text: string): { shouldBlock: boolean; reason: string } | null {
